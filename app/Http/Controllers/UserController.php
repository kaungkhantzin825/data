...
class UserController extends Controller
{
    ...
    {
        $usersQuery = User::with(['roles', 'tenant', 'plan', 'staff'])->latest();
    ...
    public function store(Request $request)
    {
        ...
        $user = User::create([
            ...
            'plan_expired_at' => $authUser->is_admin ? $request->plan_expired_at : $authUser->plan_expired_at,
        ]);
    ...
    public function update(Request $request, User $user)
    {
        ...
        if (auth()->user()->is_admin) {
            ...
            $user->plan_expired_at = $request->plan_expired_at;
        }
